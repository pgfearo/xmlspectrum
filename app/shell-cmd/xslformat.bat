...
goto loop
:afterloop
java -cp "%SAXON_HOME%\saxon9he.jar" net.sf.saxon.Transform -xsl:%xslpath% -it:main sourcepath=%source% output-method=text output-path=%opath%%cmd%
type %fullofpath%
echo -----------------------
echo args:  %cmd%
echo written to: %fullofpath%
