...
<h3><a name="w3c-doctype" id="w3c-doctype"></a>W3C Recommendation 08 April 2014</h3>
<p>Reproduced from the W3C documentation at: <a href="http://www.w3.org/TR/2014/REC-xquery-30-20140408/">http://www.w3.org/TR/2014/REC-xquery-30-20140408/</a>. <em>See copyright notice on page footer.</em></p>
...
<li>
<xsl:if test="preceding-sibling::*[1][not(@class eq 'exampleInner')]">
